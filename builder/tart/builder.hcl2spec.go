...
type FlatConfig struct {
	...
	UIAutomation              *uiauto.FlatConfig `mapstructure:"ui_automation" cty:"ui_automation" hcl:"ui_automation"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"ui_automation":                &hcldec.BlockSpec{TypeName: "ui_automation", Nested: hcldec.ObjectSpec((*uiauto.FlatConfig)(nil).HCL2Spec())},
	}
	return s
}
