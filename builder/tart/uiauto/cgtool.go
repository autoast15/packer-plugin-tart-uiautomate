...
func (c *CGTool) Capture(ctx context.Context, path string) error { return c.run(ctx, "screenshot", path) }
func (c *CGTool) Move(ctx context.Context, x, y int) error { return c.run(ctx, "move", strconv.Itoa(x), strconv.Itoa(y)) }
func (c *CGTool) Click(ctx context.Context, x, y int) error { return c.run(ctx, "click", strconv.Itoa(x), strconv.Itoa(y)) }
func (c *CGTool) DoubleClick(ctx context.Context, x, y int) error { return c.run(ctx, "double-click", strconv.Itoa(x), strconv.Itoa(y)) }
...
func (c *CGTool) Scroll(ctx context.Context, dx, dy int) error { return c.run(ctx, "scroll", strconv.Itoa(dx), strconv.Itoa(dy)) }
